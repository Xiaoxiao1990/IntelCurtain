...
public class DeviceAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (bleDevice != null) {
            ...
            if (Build.VERSION.SDK_INT >= 18 && bleDevice.getDevice().getType() >= BluetoothDevice.DEVICE_TYPE_LE) {
                if (isConnected) {
                    holder.img_blue.setImageResource(R.mipmap.ic_ble_connected);
                } else {
                    holder.img_blue.setImageResource(R.mipmap.ic_ble_disconnected);
                }
            } else {
                if (isConnected) {
                    holder.img_blue.setImageResource(R.mipmap.ic_bt_connected);
                } else {
                    holder.img_blue.setImageResource(R.mipmap.ic_bt_disconnected);
                }
            }
